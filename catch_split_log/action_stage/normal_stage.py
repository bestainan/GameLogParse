...
CUR_ACTION_LST = [game_define.EVENT_ACTION_STAGE_NORMAL_WIN, game_define.EVENT_ACTION_STAGE_NORMAL_FAIL, game_define.EVENT_ACTION_STAGE_MOP]    # 当前行为id表
cur_action_log_dict = dict()    # 当前行为字典
stage_result_dict = dict()
FILE_NAME = 'NORMAL_STAGE_CHALLENGE'
