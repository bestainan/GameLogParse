...
CUR_ACTION_LST = [game_define.EVENT_ACTION_TREASURE_BATTLE_FAIL,game_define.EVENT_ACTION_TREASURE_BATTLE_WIN]   # 当前行为ID列表
    ...
    for _server_id in LOCAL_LOG_PATH_NAME:
        try:
            ...
            if log_lines:
                ...
                #夺宝副本
                _output_TREASURE_BATTLE_STAGE_CHALLENGE(split_date,out_put_file_path)
        except:
            pass


def _output_TREASURE_BATTLE_STAGE_CHALLENGE(split_date,out_put_file_path):
    """
        夺宝关卡挑战数据
    ...
    # 胜利失败关卡日志字典OpenLevelTreasure
    open_level = game_config.get_game_config_val_int("OpenLevelTreasure")
