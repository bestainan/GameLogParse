...
CUR_ACTION_LST = [game_define.EVENT_ACTION_GYM_FAIL,game_define.EVENT_ACTION_GYM_WIN, game_define.EVENT_ACTION_GYM_MOP]     # 当前行为ID列表
    ...
    for _server_id in LOCAL_LOG_PATH_NAME:
        try:
            ...
            if log_lines:
                ...
                #困难副本 英雄副本
                _output_GYM_STAGE_CHALLENGE(split_date,out_put_file_path)
        except:
            pass
