...
CUR_ACTION_LST = [game_define.EVENT_ACTION_MASSAGE_REWARD]  # 当前行为ID表
    ...
    for _server_id in LOCAL_LOG_PATH_NAME_LST:
        try:
            ...
            if log_lines:
                ...
                # 按摩
                _output_MASSAGE(out_put_file_path)
        except:
            pass


def _output_MASSAGE(out_put_file_path):
    """
        按摩
        参与人数	总次数	到达要求人数	参与率
    """
    ...
    massage_logs.extend(cur_action_log_dict.get(action_str, []))#@#
