...
def log(user, add_gold, add_stone, add_free_draw, add_exp, monster_str, equip_str, item_str, activity_id):
    """
        输出日志
    """
    action = game_define.EVENT_ACTION_ACTIVITY_SEVEN_LEVEL_REWARD
    ...
    log_lst.append(str(activity_id))
...
def parse(log_part_lst):
    ...
    result['seven_level_id'] = action_base.get_val(log_part_lst, 12, 0, False)
